...
describe("Testing Radar Api", ()=>{
    // Testing POST Route
    describe("POST /radar", ()=>{
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["avoid-mech"],"scan":[{"coordinates":{"x":0,"y":40},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":0,"y":80},"allies":5,"enemies":{"type":"mech","number":1}}]}
            // |{"x":0,"y":40}
        chai.request(server)
            .post('/radar')
            .send(testData)
            .end((err, response)=> {
                ...
                response.body.should.have.property("x").eq(0);
                response.body.should.have.property("y").eq(40);
                done();
            })
        })
        it("It should NOT return any point - Bad request - Return Error code 500", (done)=>{
        const testData = {"protodgcols":["avgfhfoid-mech"],"scan":[{"coordihhhhdnates":{"x":0,"y":40},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":0,"y":80},"allies":5,"enemies":{"type":"mech","number":1}}]}
        // |{"x":0,"y":40}
        chai.request(server)
        .post('/radar')
        .send(testData)
        ...
        it("It should NOT return any point - No match conditions - Return Error code 404 and Message", (done)=>{
        const testData = {"protocols":["avoid-mech"],"scan":[{"coordinates":{},"enemies":{}},{"coordinates":{},"allies":5,"enemies":{}}]}
        // |{"x":0,"y":40}
        chai.request(server)
        .post('/radar')
        .send(testData)
        .end((err, response)=> {
            ...
            response.body.should.have.property("message").eq("There are no valid targets");
            done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["prioritize-mech"],"scan":[{"coordinates":{"x":0,"y":40},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":0,"y":80},"allies":5,"enemies":{"type":"mech","number":1}}]}
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                ...
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(0);
                response.body.should.have.property("y").eq(80);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["closest-enemies"],"scan":[{"enemies":{"number":10,"type":"soldier"},"coordinates":{"y":35,"x":5}},{"enemies":{"number":20,"type":"soldier"},"coordinates":{"y":30,"x":10}}]}
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(10);
                response.body.should.have.property("y").eq(30);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["furthest-enemies"],"scan":[{"enemies":{"number":10,"type":"soldier"},"coordinates":{"y":35,"x":5}},{"enemies":{"number":20,"type":"soldier"},"coordinates":{"y":30,"x":10}}]}
            // |{"x":5,"y":35}
        chai.request(server)
            .post('/radar')
            .send(testData)
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(5);
                response.body.should.have.property("y").eq(35);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["assist-allies"],"scan":[{"enemies":{"number":10,"type":"soldier"},"allies":3,"coordinates":{"y":35,"x":5}},{"enemies":{"number":20,"type":"soldier"},"coordinates":{"y":5,"x":35}}]}
            // |{"x":5,"y":35}
        chai.request(server)
            .post('/radar')
            .send(testData)
        ...
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["avoid-crossfire"],"scan":[{"enemies":{"number":10,"type":"soldier"},"allies":3,"coordinates":{"y":35,"x":5}},{"enemies":{"number":20,"type":"soldier"},"coordinates":{"y":5,"x":35}}]}
            // |{"x":35,"y":5}
        chai.request(server)
            .post('/radar')
            .send(testData)
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(35);
                response.body.should.have.property("y").eq(5);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
        ...
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["closest-enemies","avoid-mech"],"scan":[{"coordinates":{"x":0,"y":1},"enemies":{"type":"mech","number":1}},{"coordinates":{"x":0,"y":10},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":0,"y":99},"enemies":{"type":"mech","number":1}}]}
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(3);
                response.body.should.have.property("y").eq(10);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["furthest-enemies"],"scan":[{"coordinates":{"x":89,"y":13},"enemies":{"type":"mech","number":1}},{"coordinates":{"x":11,"y":35},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":19,"y":49},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":38,"y":21},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":10,"y":39},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":13,"y":38},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":13,"y":15},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":30,"y":19},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":30,"y":11},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":15,"y":19},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":22,"y":15},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":10,"y":19},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":94,"y":11},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":10,"y":19},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":90,"y":18},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":80,"y":51},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":70,"y":91},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":30,"y":11},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":30,"y":95},"enemies":{"type":"mech","number":20}},{"coordinates":{"x":1,"y":89},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":3,"y":11},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":54,"y":19},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":22,"y":38},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":3,"y":10},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":43,"y":13},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":51,"y":13},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":91,"y":30},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":11,"y":30},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":91,"y":15},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":51,"y":22},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":91,"y":10},"enemies":{"type":"mech","number":10}},{"coordinates":{"x":11,"y":84},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":91,"y":65},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":81,"y":53},"enemies":{"type":"mech","number":30}},{"coordinates":{"x":15,"y":70},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":19,"y":83},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":11,"y":46},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":59,"y":26},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":98,"y":57},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":11,"y":58},"enemies":{"type":"mech","number":80}},{"coordinates":{"x":91,"y":39},"enemies":{"type":"mech","number":10}},{"coordinates":{"x":83,"y":37},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":0,"y":11},"enemies":{"type":"mech","number":1}}]}
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(30);
                response.body.should.have.property("y").eq(95);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
            const testData = {"protocols":["furthest-enemies","avoid-mech"],"scan":[{"coordinates":{"x":89,"y":13},"enemies":{"type":"mech","number":1}},{"coordinates":{"x":11,"y":35},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":19,"y":49},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":38,"y":21},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":10,"y":39},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":13,"y":38},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":13,"y":15},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":30,"y":19},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":30,"y":11},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":15,"y":19},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":22,"y":15},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":10,"y":19},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":94,"y":11},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":10,"y":19},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":90,"y":18},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":80,"y":51},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":70,"y":91},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":30,"y":11},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":30,"y":95},"enemies":{"type":"mech","number":20}},{"coordinates":{"x":1,"y":89},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":3,"y":11},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":54,"y":19},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":22,"y":38},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":3,"y":10},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":43,"y":13},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":51,"y":13},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":91,"y":30},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":11,"y":30},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":91,"y":15},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":51,"y":22},"enemies":{"type":"soldier","number":80}},{"coordinates":{"x":91,"y":10},"enemies":{"type":"mech","number":10}},{"coordinates":{"x":11,"y":84},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":91,"y":65},"enemies":{"type":"soldier","number":10}},{"coordinates":{"x":81,"y":53},"enemies":{"type":"mech","number":30}},{"coordinates":{"x":15,"y":70},"enemies":{"type":"soldier","number":30}},{"coordinates":{"x":19,"y":83},"enemies":{"type":"soldier","number":15}},{"coordinates":{"x":11,"y":46},"enemies":{"type":"soldier","number":60}},{"coordinates":{"x":59,"y":26},"enemies":{"type":"soldier","number":40}},{"coordinates":{"x":98,"y":57},"enemies":{"type":"soldier","number":20}},{"coordinates":{"x":11,"y":58},"enemies":{"type":"mech","number":80}},{"coordinates":{"x":91,"y":39},"enemies":{"type":"mech","number":10}},{"coordinates":{"x":83,"y":37},"enemies":{"type":"mech","number":10}},{"coordinates":{"x":0,"y":11},"enemies":{"type":"mech","number":1}}]}
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(91);
                response.body.should.have.property("y").eq(30);
                done();
            })
        })
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                ...
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(0);
                response.body.should.have.property("y").eq(11);
                done();
            })
        })
        it("It should return the exact coordinates to fire", (done)=>{
        ...
        chai.request(server)
            ...
            .end((err, response)=> {
                response.should.have.status(200);
                response.body.should.be.a("object");
                response.body.should.have.property("x").eq(11);
                response.body.should.have.property("y").eq(58);
                done();
            })
        })
